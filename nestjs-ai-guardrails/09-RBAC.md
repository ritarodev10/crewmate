...
This is the authorization model for CrewMate. Read this end to end before changing any guard, ability rule, or scoped repository method. It pairs with `08-SECURITY.md`, which covers transport-level security and tenant isolation.
