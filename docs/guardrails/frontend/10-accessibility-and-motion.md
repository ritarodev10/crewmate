...
Board-level shortcuts live in chapter 14. The summary is that ArrowLeft and ArrowRight move a focused card between columns, Space picks up and drops a card, and Esc cancels a pickup.
