...
| Subtitle | `text-small text-muted`, sits inline next to the title with `space-3` gap on desktop, breaks below the title on tablet |
...
The worker shell is documented in detail in `07-worker-mobile.md`.
